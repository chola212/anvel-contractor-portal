...
import {
  updateOwnContractorProfileAction,
  type ContractorSelfUpdateState,
...
type ContractorSelfUpdateFormProps = {
...
export function ContractorSelfUpdateForm({
  contractor,
}: ContractorSelfUpdateFormProps) {
  const router = useRouter();
  const initialState: ContractorSelfUpdateState = {
    message: null,
    status: "idle",
    fieldErrors: {},
  };
      ...
      <form action={formAction} className="mt-5 grid gap-5">
        <div className="grid gap-5 lg:grid-cols-2">
          <div className="space-y-2">
            <label
              htmlFor={`self-legal-name-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Legal name
            </label>
            <input
              id={`self-legal-name-${contractor.id}`}
              name="legalName"
              type="text"
              required
              maxLength={160}
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-trading-name-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Trading name
            </label>
            <input
              id={`self-trading-name-${contractor.id}`}
              name="tradingName"
              type="text"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-phone-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Phone
            </label>
            <input
              id={`self-phone-${contractor.id}`}
              name="phone"
              type="tel"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-country-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Country
            </label>
            <input
              id={`self-country-${contractor.id}`}
              name="country"
              type="text"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-supplier-type-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Supplier type
            </label>
            <select
              id={`self-supplier-type-${contractor.id}`}
              name="supplierType"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-vat-treatment-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              VAT treatment
            </label>
            <select
              id={`self-vat-treatment-${contractor.id}`}
              name="vatTreatment"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-company-registration-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Company registration number
            </label>
            <input
              id={`self-company-registration-${contractor.id}`}
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-vat-number-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              VAT number
            </label>
            <input
              id={`self-vat-number-${contractor.id}`}
              name="vatNumber"
              type="text"
          ...
          <div className="space-y-2">
            <label
              htmlFor={`self-tax-number-${contractor.id}`}
              className="block text-sm font-medium text-neutral-800"
            >
              Tax number
            </label>
            <input
              id={`self-tax-number-${contractor.id}`}
              name="taxNumber"
              type="text"
