...
function frameworkLines(input: OnboardingDocumentFormData): PdfLine[] {
  return [
    ...
    p("This Freelance Consultant Framework Agreement is entered into between ANVEL Consulting and the Consultant identified below. It governs freelance services provided by the Consultant to ANVEL Consulting for projects and assignments connected with CSO Wesel and its clients."),
    h("ANVEL Consulting"),
    p("ERP UTILITIES CONSULTING SERVICES LTD, trading for these purposes as ANVEL Consulting"),
    h("Consultant"),
    p(input.consultantLegalName),
    p(input.consultantAddress),
    ...
    p("ANVEL Consulting may engage the Consultant to provide SAP consulting, development, support or related professional services in connection with CSO Wesel projects."),
    ...
    h("3. Services"),
    p("The Consultant will provide the services with reasonable professional skill, care and diligence, in line with the assignment description, applicable project standards and instructions reasonably provided by ANVEL Consulting, CSO Wesel or the relevant end client."),
    ...
    p("Only hours recorded in timesheets and approved through the applicable CSO Wesel or end-client approval process are billable."),
    ...
    h("6. Confidentiality"),
    p("The Consultant must keep confidential all information received from or concerning ANVEL Consulting, CSO Wesel, any end client, their systems, processes, documents, business data, technical data, pricing, credentials, project information and personal data."),
    ...
    p("The Consultant must not make commitments on behalf of ANVEL Consulting, CSO Wesel or any end client unless expressly authorised in writing."),
    h("11. Termination"),
...
function assignmentLines(input: OnboardingDocumentFormData): PdfLine[] {
  ...
  return [
    ...
    p("This Assignment Schedule sets out the commercial and operational terms for a specific CSO Wesel-related assignment. It should be read together with the Freelance Consultant Framework Agreement and the NDA / Data Protection Undertaking signed by the Consultant."),
    ...
    p("The Consultant will provide SAP consulting, development, support or related professional services for a CSO Wesel-related assignment."),
    p(`Specific responsibilities: ${input.specificResponsibilities}`),
    p("The Consultant will coordinate with ANVEL Consulting and, where required, with CSO Wesel or the relevant end-client contacts."),
    ...
    p("At the end of each completed month, once the monthly timesheet has been approved by CSO Wesel or the end client, the approved timesheet shall be sent to ANVEL Consulting."),
    ...
    p("ANVEL Consulting may terminate the assignment with immediate effect in case of serious breach, misconduct, confidentiality breach, security breach, non-performance, loss of client approval, or termination/suspension of the corresponding assignment by CSO Wesel or the end client."),
    p("If CSO Wesel or the end client terminates, suspends or reduces the assignment, ANVEL Consulting may terminate or adjust the Consultant's assignment accordingly."),
...
function ndaLines(input: OnboardingDocumentFormData): PdfLine[] {
  return [
    ...
    p("This undertaking applies to all services performed by the Consultant in connection with ANVEL Consulting, CSO Wesel and any related end-client assignment."),
    h("ANVEL Consulting"),
    p("ERP UTILITIES CONSULTING SERVICES LTD, trading for these purposes as ANVEL Consulting"),
    h("Consultant"),
    p(input.consultantLegalName),
